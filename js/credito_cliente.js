    ...
    let registroArray = creditoVentaArray;
    ...
    function obtenerNumTicket(id) {
        for (let i = 0; i < ventasArray.length; i++) {
            const e = ventasArray[i];
            if (e.id == id) {
                return e.num_ticket;
            }
        }
    ...
    function mostrarDatos() {
        ...
        registroArray.forEach(e => {
            ...
            <tr>
                <td>${e.id}</td>
                <td>${obtenerNumTicket(e.idventa)}</td>
                ...
                <td>
                    <button type="button" id="pagarCredito" class="btn btn_secundario">Cobrar</button>
                </td>
            </tr>
            `;
        });
    ...
    $(document).on("click", "#pagarCredito", function () {
        ...
        if (credito.faltante != 0) {
            ...
            $("#cliente-modal").text("Cliente : " + obtenerCliente(credito.idcliente));
    ...
    $(document).on("click", "#btn-form-modal", function () {
        if(id > 0){
