...
$('#btn_guardar').click(function (e) {
    ...
    e.preventDefault();
    if($('#nombre').val() == ''){
        alertify.error('Falta el nombre de la marca');
        guardar = false;
        $('#nombre').focus();
    }
...
function nuevoRegistro(nombre){
    let id = getId() + 1;
    let nuevaMarca = marcaModel(id, nombre);
    
    registrosArray.push(nuevaMarca);
